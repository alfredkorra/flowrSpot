...
function Navbar() {
  ...
  function handleButtonClick(buttonType) {
    ...
    } else if (buttonType === "create-account") {
       ...
       <nav className="navbar container" onClick={(e) => e.stopPropagation()}>
        <div className="nav-container">
          ...
          <ul className={click ? "nav-menu active" : "nav-menu"}>
            ...
            <li className="nav-item">
              <button
                onClick={() => handleButtonClick("login", setShowModal(true))}
                className="nav-links___login"
              >
                Login
              </button>
            </li>
            <button
              className="create_acc__button"
              onClick={() =>
                handleButtonClick("create-account", setShowModal(true))
              }
            >
              New Account
            </button>
            {showModal && (
              <Modal onRemoveModal={hideModalHandler} id="create-account-modal">
                {modalContent}
              </Modal>
            )}
          </ul>
